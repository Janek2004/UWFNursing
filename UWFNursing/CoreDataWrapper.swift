...
@objc  class CoreDataWrapper :NSObject{
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = NSBundle.mainBundle().URLForResource("NursingModel", withExtension: "momd")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
		...
		let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("UWFNursing.sqlite")
    ...
    func updateProximityData(proximity:CLProximity, beacon:String){
        var proximity  = self.createNewProximity()
        proximity.timestamp =  NSDate()
        proximity.beaconid = beacon
        self.saveToDatabase();
